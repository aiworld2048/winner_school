        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-end mb-3">
                    @if(count($types) != 2)
                    <a href="{{ route('admin.contacts.create') }}" class="btn bg-gradient-success btn-sm mb-0">+&nbsp; New
                        Contact</a>
                    @endif
                </div>
                        ...
                        <table id="mytable" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.contacts.edit', $contact->id) }}" data-bs-toggle="tooltip"
                                            data-bs-original-title="Edit Contact"> <i class="fas fa-edit text-info mr-2"
                                                style="font-size: 20px;"></i></a>
                                        <a href="{{ route('admin.contacts.show', $contact->id) }}" data-bs-toggle="tooltip"
                                            data-bs-original-title="Preview Contact Detail">
                                            <i class="fa-solid fa-eye  text-success " style="font-size: 20px;"></i>
                                        </a>
                                        <form class="d-inline" action="{{ route('admin.contacts.destroy', $contact->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')

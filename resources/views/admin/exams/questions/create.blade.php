            ...
            <div class="card-body">
                <form action="{{ route('admin.exams.questions.store', $exam) }}" method="POST" id="questionForm">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="marks" id="marks" class="form-control" 
                                       value="{{ old('marks', 1) }}" step="0.1" min="0.1" max="100" required>
                                @error('marks')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="question_description" id="question_description" class="form-control">{{ old('question_description') }}</textarea>
...
<script>
    $(function () {
        ...
        // Trigger change on load if type is set
        if ($('#type').val()) {
            $('#type').trigger('change');
        }

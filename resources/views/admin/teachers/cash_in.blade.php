            ...
            <div class="card col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1" style="border-radius: 15px;">
                <div class="card-header">
                    <div class="card-title col-12">
                        <h5 class="d-inline fw-bold">Teacher Deposit (Cash In)</h5>
                        <a href="{{ route('admin.teachers.index') }}" class="btn btn-primary float-right">
                            <i class="fas fa-arrow-left" style="font-size: 20px;"></i> Back
                        </a>
                    </div>
                </div>
                <form action="{{ route('admin.teacher.wallet.cash_in.make', $agent->id) }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="" value="{{$agent->name}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Current Balance<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ number_format((float) $agent->balance, 2) }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Amount<span class="text-danger">*</span></label>
                                    <span class="badge badge-success">Max:{{ number_format((float) auth()->user()->balance, 2) }}</span>

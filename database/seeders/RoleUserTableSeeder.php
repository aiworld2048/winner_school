...
class RoleUserTableSeeder extends Seeder
{
    private const ROLE_IDS = [
        UserType::HeadTeacher->value => 1,  // HeadTeacher role id
        UserType::Teacher->value => 2,      // Teacher role id
        UserType::Student->value => 3,      // Student role id
        UserType::SystemWallet->value => 4, // SystemWallet role id
